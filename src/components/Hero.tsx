  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 z-10 flex flex-col items-center">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="pt-3 mt-2 flex items-center justify-between border-t border-[#FFF7E8]/10">
                        ...
                        <button
                          ...
                          className={`px-3.5 py-2 rounded-full text-xs font-bold transition-all flex items-center gap-1.5 shadow-md active:scale-95 btn-shimmer-sheen ${
                            isAdded
                  ...
                  <div className="w-full rounded-3xl p-5 bg-gradient-to-b from-[#3D0A16]/95 via-[#2E0710]/95 to-[#24050D]/95 border-2 border-[#F4BD38]/50 shadow-2xl backdrop-blur-md">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="pt-3 mt-2 flex items-center justify-between border-t border-[#FFF7E8]/10">
                        ...
                        <button
                          onClick={(e) => handleAddToCart(e, item.id)}
                          className={`px-5 py-2 rounded-full text-xs font-black transition-all flex items-center gap-1.5 shadow-md active:scale-95 btn-shimmer-sheen ${
                            isAdded
        ...
        {/* ========================================================================= */}
        <div 
          className={`mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 z-20 transition-all duration-700 ${
            loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
          }`}
        ...
        >
          <button
            ...
            className="group relative bg-gradient-to-r from-[#F4BD38] via-[#F7CD5C] to-[#F4BD38] text-[#52091B] px-8 sm:px-10 py-3.5 sm:py-4 rounded-full text-xs sm:text-sm font-black uppercase tracking-widest shadow-[0_10px_25px_rgba(244,189,56,0.3)] hover:shadow-[0_15px_35px_rgba(244,189,56,0.45)] hover:scale-105 transition-all duration-300 transform active:scale-95 flex items-center gap-3 border border-[#FFF7E8]/40 btn-shimmer-sheen"
          >
          ...
          <button
            ...
            className="text-xs sm:text-sm font-bold text-[#FFF7E8]/85 hover:text-[#F4BD38] transition-colors py-2 px-3 flex items-center gap-1.5 group"
          >
